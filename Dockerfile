...
ADD https://download.jetbrains.com/teamcity/TeamCity-2025.03.2.tar.gz $TEAMCITY_DIST/
...
ADD https://jdbc.postgresql.org/download/postgresql-42.7.3.jar /data/teamcity_server/datadir/lib/jdbc/
