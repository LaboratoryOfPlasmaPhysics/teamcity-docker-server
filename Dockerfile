...
RUN dnf install -y java-21-openjdk mercurial git tar gzip tomcat apr
...
ADD https://download.jetbrains.com/teamcity/TeamCity-2025.11.1.tar.gz $TEAMCITY_DIST/
...
ADD https://jdbc.postgresql.org/download/postgresql-42.7.7.jar /data/teamcity_server/datadir/lib/jdbc/
