...
ADD https://download.jetbrains.com/teamcity/TeamCity-2021.1.2.tar.gz $TEAMCITY_DIST/
...
ADD https://jdbc.postgresql.org/download/postgresql-42.2.20.jar /data/teamcity_server/datadir/lib/jdbc/
