...
ADD https://download.jetbrains.com/teamcity/TeamCity-2022.04.4.tar.gz $TEAMCITY_DIST/
...
ADD https://jdbc.postgresql.org/download/postgresql-42.3.1.jar /data/teamcity_server/datadir/lib/jdbc/
